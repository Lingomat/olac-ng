...
from harvester_static import OLACStatic
from harvester_pmh import OLACPMH
...
def harvest_one(db: OLACDatabase, archive: XMLArchive, force: bool = False) -> bool:
    ...
    if archivetype == 'static':
        harvester = OLACStatic(db, archive) 
    else:
        harvester = OLACPMH(db, archive)
...
if __name__ == "__main__":
    ...
    if args.initonly:
        ...
        db.init()
        harvest(args.db, args.harvest, args.force)
